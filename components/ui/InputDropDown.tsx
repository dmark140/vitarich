    ...
    <div className="relative w-full">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "field-sizing-content file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground border-input flex h-[28px] w-full min-w-0 rounded-md border px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
      ...
      {isOpen &&
        ...
        createPortal(
          <div
            ...
            className="z-[9999] rounded-md border bg-background shadow-md overflow-auto"
          >
